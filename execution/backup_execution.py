...
class BackupExecutionLogic:
    ...
    def iterate_config_script(self,json_dict, home, logger):
        c = 1
        result = []
    ...
    def __execute_selection_of_external_script(self,json_dict, scripts_modules, home_folder, logger):
        loaded_scripts = []
        for section in json_dict[scripts_modules]:
            if section == 'ACTION' and json_dict[scripts_modules][section] == "execute":
                ...
                # Execute command
                try:
                    print 'AAAAAAAAAAAAAAAA' + module_to_call
