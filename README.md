...
This step should work correctly, if it does you can skip the following steps of this section:
...
[edit] Executable Scripts and improvements
...
Retries for AWS, OSS uploads and BRT reports.
...
Being able to deploy the new backups system nc-backup-py
[edit] Requirements
...
# alicmd --show    
chinanetcloud 2012-06-19T07:05:33.000Z  # Should list all buckets we have

Login Web page for Aliyun
URL: www.aliyun.com (username and password in KeepassX) Selete 
用户中心 --> 管理控制台 --> 开放存储服务OSS --> OSS 管理 --> OSS体验站
Check the backup files
# alicmd -l

[edit]Testing Do not use for now
Install OSS SKD:
pip install OSS2
python 2.7 or 2.6
[edit] Python modules
...
Aliyun documentation here: https://help.aliyun.com/document_detail/32026.html?spm=5176.doc32027.6.296.03bgw0
[edit] Other requirements (Optionals)
...
[edit] Check that the user ncbackup exists
...
[edit] Configure credentails accordingly
...
[edit]General tips to keep present:
...
[edit] Sections and modules specifics
...
[edit]if the server doing backups has python 2.7
...
[edit] if the server doing backups has python 2.6
...
[edit] Reference Manual the JSON file:
...
[edit]Other MySQL instructions to be documented
...
[edit] gpg-agent --daemon on python 2.6
